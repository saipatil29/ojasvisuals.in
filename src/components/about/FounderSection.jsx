...
import ghanshyamImg from '../../assets/images/ghanshyam_patel.jpg';
...
export const FounderSection = () => {
  ...
  return (
    <section id="about" className="relative py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      {/* Core Creative Team Members Grid (Ghanshyam Patel & Ravi Panchal) */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-8 rounded-3xl bg-gradient-to-b from-dark-800/90 to-dark-900 border border-cyan-500/20 hover:border-cyan-400/50 shadow-xl shadow-black/50 transition-all duration-300 flex flex-col items-center text-center relative group">
          <div className="relative w-36 h-48 rounded-2xl overflow-hidden mb-6 border-2 border-cyan-500/30 shadow-lg shadow-cyan-500/10 group-hover:scale-105 transition-transform bg-dark-900 flex items-center justify-center text-cyan-400">
            {/* Elegant avatar presentation with icon & gradient */}
            <div className="w-full h-full bg-gradient-to-br from-cyan-950/80 via-dark-800 to-dark-900 flex flex-col items-center justify-center p-4">
              <span className="text-4xl mb-2">📈</span>
              <span className="text-[11px] font-bold text-cyan-300 uppercase tracking-wider">Strategy</span>
            </div>
